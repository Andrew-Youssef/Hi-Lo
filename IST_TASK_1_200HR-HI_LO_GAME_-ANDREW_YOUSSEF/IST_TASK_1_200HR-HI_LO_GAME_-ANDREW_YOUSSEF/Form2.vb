Public Class frmeasygame
    ...
    Private Sub frmgame_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Randomize()
        value = CInt(Int((20 * Rnd()) + 1))     'makes the computer generate a random number between 1 and 20
        frmcongrats.lbleasy.Visible = True
    End Sub
    ...
    Private Sub btngo_Click(sender As Object, e As EventArgs) Handles btngo.Click
        ...
        If guess = value Then
            ...
            timeasygame.Enabled = False         'stops the timer
            frmcongrats.lbltime.Text = lbleasygametim.Text  'states the time it took the player to figure out the secret number on the last form
        End If
    ...
    Private Sub Timeasygame_Tick(sender As Object, e As EventArgs) Handles timeasygame.Tick
        lbleasygametim.Text = Val(lbleasygametim.Text) + 1      'makes the timer work
